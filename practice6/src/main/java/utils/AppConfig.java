...
public class AppConfig {
    ...
    public static final String COMPRESSED_DIR = "data/compressed-output";
    ...
    public static final int INITIAL_DICTIONARY_SIZE = 9_400_000;
    ...
    public static final int FRONT_CODING_BLOCK_SIZE = 8;

    public static void initDirectories() {
        new File(TEMP_DIR).mkdirs();
        new File(OUTPUT_DIR).mkdirs();
        new File(COMPRESSED_DIR).mkdirs();
    }
}