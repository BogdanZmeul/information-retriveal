...
public class Indexer {
    public static void index(String[] filePaths, BooleanDictionary<?> dictionary, Tokenizer tokenizer) {
        for (String path : filePaths) {
            indexSingleFile(path, dictionary, tokenizer);
        }
    }

    private static void indexSingleFile(String filePath, BooleanDictionary<?> dictionary, Tokenizer tokenizer) {
