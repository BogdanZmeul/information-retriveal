...
public class BooleanSearchZmeul<T> {
    private final BooleanDictionary<T> dictionary;
    private final TokenizerZmeul tokenizer;

    public BooleanSearchZmeul(BooleanDictionary<T> dictionary, TokenizerZmeul tokenizer) {
    ...
    private void applyOperator(ArrayDeque<T> values, String op) {
        if (op.equals("NOT")) {
            if (values.isEmpty()) {
